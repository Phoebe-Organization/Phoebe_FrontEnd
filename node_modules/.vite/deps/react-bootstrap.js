import {
  Spinner_default
} from "./chunk-CLL7SRUD.js";
import {
  Container_default
} from "./chunk-4CMCBJKF.js";
import {
  Anchor_default,
  Button_default,
...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-65CW55BC.js";
import "./chunk-NFS45OIZ.js";
import {
  DEFAULT_BREAKPOINTS,
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-AZHAZDWB.js";
import {
  require_jsx_runtime
} from "./chunk-73DCXBDI.js";
import {
  require_react
...
ModalHeader.defaultProps = defaultProps16;
...
var Modal = React56.forwardRef(({
  ...
  const renderBackdrop = (0, import_react31.useCallback)((backdropProps) => (0, import_jsx_runtime58.jsx)("div", {
    ...backdropProps,
...
Modal.defaultProps = defaultProps17;
...
var Overlay = React58.forwardRef((props, outerRef) => {
  ...
  if (Transition) {
    ...
    child = (0, import_jsx_runtime61.jsx)(Transition, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
Popover.defaultProps = defaultProps18;
...
Overlay2.defaultProps = defaultProps19;
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime67.jsxs)(import_jsx_runtime66.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react36.cloneElement)(children, triggerProps), (0, import_jsx_runtime65.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
OverlayTrigger.defaultProps = defaultProps20;
...
PageItem.defaultProps = defaultProps21;
PageItem.displayName = "PageItem";
var PageItem_default = PageItem;
function createButton(name, defaultValue, label = name) {
  const Button2 = React63.forwardRef(({
    children,
    ...props
...
ProgressBar.defaultProps = defaultProps22;
...
Ratio.defaultProps = defaultProps23;
...
var SplitButton = React70.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
...
var TabPanel = React72.forwardRef(
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
var TabPane = React75.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
...
var Tab = () => {
  ...
  return (0, import_jsx_runtime84.jsx)(import_jsx_runtime83.Fragment, {});
};
...
var Table = React77.forwardRef(({
  ...
  const table = (0, import_jsx_runtime85.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime86.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime86.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime87.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime86.jsx)(Nav_default2, {
      ...controlledProps,
      role: "tablist",
      as: "ul",
      children: map(children, renderTab)
    }), (0, import_jsx_runtime86.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime86.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
Tabs2.defaultProps = defaultProps25;
...
var ToastFade = React79.forwardRef((props, ref) => (0, import_jsx_runtime88.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContainer = React83.forwardRef(({
  ...
  return (0, import_jsx_runtime92.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames57.default)(bsPrefix, position && [containerPosition ? `position-${containerPosition}` : null, positionClasses[position]], className)
  });
});
